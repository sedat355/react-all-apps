...
const TablePage = () => {
  ...
  const fruits = [
    ...
    { id: 3, name: "Lime", color: "bg-green-500", score: "4" },
  ]
  ...
  const cars = [
    ...
    { id: 1, brand: "BMW", color: "bg-red-500", year: "2015", price: 9000 },
    { id: 2, brand: "Toyota", color: "bg-green-500", year: "2019", price: 12000 },
    { id: 3, brand: "Honda", color: "bg-yellow-500", year: "2010", price: 11000 },
  ]

  const configCars = [
    { title: 'Brand',
      render: (obj) => obj.brand,
      sortValue: (obj) => obj.brand 
    },
    { title: 'Color',
      render: function(obj) { return <span className={`colorCol ${obj.color}`}></span> },
    },
    { title: 'Price',
      ...
      sortValue: (obj) => obj.price
    },
    { title: 'Year',
      render: function(obj) { return obj.year },
      sortValue: (obj) => obj.year
    },
  ]
  ...
  return (
    <div>
      ...
      <SortableTable data={cars} config={configCars} caption="Cars Table"/>
